...
const newsData = [
    ...
    // EAST DUNBARTONSHIRE & NORTH GLASGOW
    {
        id: 64,
        title: "Milngavie Reservoir Path Reopens After Storm Damage",
        content: "The popular walking path around Mugdock Reservoir has reopened following repairs to sections damaged in December storms. East Dunbartonshire Council has also installed new signage and benches along the route.",
        location: "Milngavie",
        lat: 55.9420,
        lng: -4.3170,
        category: "community",
        source: "Milngavie Herald",
        sourceUrl: "https://www.milngavieherald.co.uk/",
        date: "2026-01-12"
    },
    {
        id: 65,
        title: "West Highland Way Celebrates Record Walker Numbers",
        content: "The West Highland Way, which starts in Milngavie, saw a record 40,000 completions in 2025. Local businesses report a boost from the increased footfall, with calls for improved facilities at the trailhead.",
        location: "Milngavie (West Highland Way)",
        lat: 55.9398,
        lng: -4.3130,
        category: "events",
        source: "The Herald",
        sourceUrl: "https://www.heraldscotland.com/",
        date: "2026-01-08"
    },
    {
        id: 66,
        title: "New Cycle Path Connects Milngavie to Bearsden",
        content: "A new segregated cycle path linking Milngavie town centre to Bearsden Cross has been completed. The 2-mile route aims to encourage more residents to cycle for local journeys.",
        location: "Milngavie to Bearsden",
        lat: 55.9350,
        lng: -4.3250,
        category: "traffic",
        source: "East Dunbartonshire Council",
        sourceUrl: "https://www.eastdunbarton.gov.uk/",
        date: "2026-01-10"
    },
    {
        id: 67,
        title: "Bearsden Primary School Wins Green Flag Award",
        content: "Bearsden Primary has been awarded its third Eco-Schools Green Flag for environmental initiatives including a new wildlife garden and plastic-free lunch campaign.",
        location: "Bearsden",
        lat: 55.9180,
        lng: -4.3340,
        category: "community",
        source: "Bearsden & Milngavie Herald",
        sourceUrl: "https://www.milngavieherald.co.uk/",
        date: "2026-01-14"
    },
    {
        id: 68,
        title: "Kirkintilloch Canal Festival Dates Announced",
        content: "The annual Kirkintilloch Canal Festival will return in August with an expanded programme. Early bird tickets for the headline concert are now available.",
        location: "Kirkintilloch",
        lat: 55.9393,
        lng: -4.1530,
        category: "events",
        source: "Kirkintilloch Herald",
        sourceUrl: "https://www.kirkintillochherald.co.uk/",
        date: "2026-01-11"
    },
    {
        id: 69,
        title: "Bishopbriggs Retail Park Expansion Approved",
        content: "Plans for new retail units at Bishopbriggs Retail Park have been approved by East Dunbartonshire Council. Construction is expected to begin in spring 2026, creating 150 jobs.",
    ...
    {
        id: 70,
        title: "Lenzie Academy Students Win National Science Award",
        content: "A team from Lenzie Academy has won the Scottish Young Engineers competition with their sustainable energy project. The students will now represent Scotland at the UK finals.",
        location: "Lenzie",
        lat: 55.9220,
        lng: -4.1550,
        category: "community",
    ...
    {
        id: 71,
        title: "Mugdock Country Park Winter Events Programme",
        content: "Mugdock Country Park has announced its winter events programme, including guided wildlife walks, photography workshops, and family nature trails throughout January and February.",
        location: "Mugdock Country Park",
        lat: 55.9580,
        lng: -4.3100,
        category: "events",
        source: "East Dunbartonshire Leisure",
        sourceUrl: "https://www.edlc.co.uk/",
        date: "2026-01-06"
    },
    {
        id: 72,
        title: "A81 Roadworks Cause Milngavie Delays",
        content: "Essential water main repairs on the A81 near Milngavie are causing delays of up to 20 minutes during peak hours. Works are expected to continue until the end of January.",
        location: "A81 Milngavie",
        lat: 55.9380,
        lng: -4.3200,
        category: "traffic",
        source: "Traffic Scotland",
    ...
    {
        id: 73,
        title: "Bearsden Community Hub Plans Unveiled",
        content: "Plans for a new community hub in Bearsden town centre have been unveiled, featuring a library, cafe, and flexible community spaces. Public consultation is now open.",
        location: "Bearsden",
        lat: 55.9170,
        lng: -4.3290,
        category: "council",
    ...
    {
        id: 74,
        title: "Break-in Spree Targets Milngavie Businesses",
        content: "Police are investigating a series of break-ins at shops on Station Road, Milngavie. Three businesses were targeted overnight on January 10th. CCTV footage is being reviewed.",
        location: "Milngavie Town Centre",
        lat: 55.9410,
        lng: -4.3140,
        category: "crime",
        source: "Police Scotland",
    ...
    {
        id: 75,
        title: "Allander Leisure Centre Pool Refurbishment Complete",
        content: "The swimming pool at Allander Leisure Centre in Bearsden has reopened following a major refurbishment. New features include improved changing facilities and a upgraded filtration system.",
        location: "Bearsden (Allander)",
        lat: 55.9270,
        lng: -4.3180,
        category: "community",
        source: "East Dunbartonshire Leisure",
    ...
    {
        id: 76,
        title: "Torrance Village Parking Review Launched",
        content: "East Dunbartonshire Council has launched a parking review in Torrance village following resident complaints about congestion near the primary school during drop-off times.",
        location: "Torrance",
        lat: 55.9580,
        lng: -4.2120,
        category: "council",
    ...
    {
        id: 77,
        title: "Strathkelvin Railway Path Improvement Works",
        content: "Improvement works on the Strathkelvin Railway Path between Kirkintilloch and Lennoxtown will begin next month. The path will remain open but some sections may have temporary diversions.",
        location: "Strathkelvin",
        lat: 55.9500,
        lng: -4.1800,
        category: "traffic",
        source: "Sustrans Scotland",
        sourceUrl: "https://www.sustrans.org.uk/",
        date: "2026-01-12"
    },
    {
        id: 78,
        title: "Lennoxtown Community Orchard Planting Day",
        content: "Volunteers are invited to help plant 50 fruit trees at the new Lennoxtown Community Orchard on Saturday 25th January. Tools and refreshments will be provided.",
        location: "Lennoxtown",
        lat: 55.9670,
        lng: -4.1980,
        category: "community",
        source: "Campsie Community Council",
        sourceUrl: "https://www.campsiecommunity.org.uk/",
        date: "2026-01-15"
    },
    // WEST DUNBARTONSHIRE & CLYDEBANK
    {
        id: 79,
        title: "Clydebank Shopping Centre Redevelopment Begins",
        content: "Major redevelopment work has begun at Clydebank Shopping Centre, including a new food court and leisure facilities. The centre will remain open during construction.",
        location: "Clydebank",
        lat: 55.9010,
        lng: -4.4040,
        category: "business",
        source: "Clydebank Post",
        sourceUrl: "https://www.clydebankpost.co.uk/",
        date: "2026-01-08"
    },
    {
        id: 80,
        title: "Dumbarton Castle Winter Opening Hours",
        content: "Dumbarton Castle has announced extended winter opening hours at weekends following increased visitor interest. The historic fortress offers panoramic views over the Clyde.",
        location: "Dumbarton",
        lat: 55.9360,
        lng: -4.5610,
        category: "events",
    ...
    {
        id: 81,
        title: "Cumbernauld Town Centre Regeneration Update",
        content: "North Lanarkshire Council has released updated plans for Cumbernauld town centre regeneration. The proposals include new housing, improved public spaces, and better pedestrian links.",
        location: "Cumbernauld",
        lat: 55.9460,
        lng: -3.9940,
        category: "council",
        source: "Cumbernauld News",
        sourceUrl: "https://www.cumbernauldnews.co.uk/",
        date: "2026-01-13"
    },
    {
        id: 82,
        title: "Kilsyth Rangers Youth Academy Launch",
        content: "Kilsyth Rangers FC has launched a new youth academy for players aged 5-16. Open trials will be held throughout January at the Duncansfield ground.",
        location: "Kilsyth",
        lat: 55.9790,
        lng: -4.0590,
        category: "community",
        source: "Kilsyth Chronicle",
        sourceUrl: "https://www.kilsythchronicle.co.uk/",
        date: "2026-01-09"
    },
    // STIRLING AREA
    {
        id: 83,
        title: "Stirling Castle Hosts Burns Night Celebration",
        content: "Stirling Castle is hosting a special Burns Night celebration on January 25th with traditional Scottish music, poetry readings, and a haggis supper in the Great Hall.",
    ...
    {
        id: 84,
        title: "Loch Lomond Winter Wildlife Watch",
        content: "Loch Lomond & The Trossachs National Park is running guided winter wildlife walks throughout January, offering chances to spot red squirrels, deer, and winter birds.",
        location: "Loch Lomond",
        lat: 56.0700,
        lng: -4.5800,
        category: "events",
        source: "Loch Lomond NPA",
        sourceUrl: "https://www.lochlomond-trossachs.org/",
        date: "2026-01-11"
    }
];
