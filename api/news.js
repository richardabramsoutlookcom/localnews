...
function extractSourceFromUrl(url) {
    try {
        ...
        const sources = {
            ...
            'sundaypost.com': 'Sunday Post',
            'scottishdailyexpress.co.uk': 'Scottish Daily Express',
            'glasgowtimes.co.uk': 'Glasgow Times',
            'dailyrecord.co.uk': 'Daily Record',
            'stv.tv': 'STV News',
            'scotlandnow.dailyrecord.co.uk': 'Scotland Now',
            'barrheadnews.com': 'Barrhead News',
            'kirkintilloch-herald.co.uk': 'Kirkintilloch Herald',
            'milngavieherald.co.uk': 'Milngavie Herald',
            'aikikenhead.co.uk': 'Airdrie & Coatbridge Advertiser',
            'cumbernauld-news.co.uk': 'Cumbernauld News',
            'dundeecourier.co.uk': 'Dundee Courier',
            'falkirkherald.co.uk': 'Falkirk Herald',
            'stirlingobserver.co.uk': 'Stirling Observer',
            'hamiltonadvertiser.co.uk': 'Hamilton Advertiser',
            'dailyrecord.co.uk': 'Daily Record',
            'motherwell-times.co.uk': 'Motherwell Times',
            'rutherglenreformer.co.uk': 'Rutherglen Reformer',
            'eastkilbridenews.co.uk': 'East Kilbride News',
            'paisleydailyexpress.co.uk': 'Paisley Daily Express',
            'greenocktelegraph.co.uk': 'Greenock Telegraph',
            'dumbartonreporter.co.uk': 'Dumbarton Reporter',
            'lennoxherald.co.uk': 'Lennox Herald',
            'helensburgh-advertiser.co.uk': 'Helensburgh Advertiser',
            'invernesscourier.co.uk': 'Inverness Courier',
            'highland-news.co.uk': 'Highland News',
            'ross-shirejournal.co.uk': 'Ross-shire Journal',
            'johnogroat-journal.co.uk': 'John O\'Groat Journal',
            'orcadian.co.uk': 'The Orcadian',
            'shetlandtimes.co.uk': 'Shetland Times',
            'obantimes.co.uk': 'Oban Times',
            'argyllshireadvertiser.co.uk': 'Argyllshire Advertiser',
            'campbeltowncourier.co.uk': 'Campbeltown Courier',
            'arranbanner.co.uk': 'Arran Banner',
            'buteman.co.uk': 'The Buteman',
            'bordertelegraph.com': 'Border Telegraph',
            'berwickshirenews.co.uk': 'Berwickshire News',
            'hawick-news.co.uk': 'Hawick News',
            'selkirkweekendadvertiser.co.uk': 'Selkirk Advertiser',
            'peeblesshirenews.com': 'Peeblesshire News',
            'dumfriesstandard.co.uk': 'Dumfries Standard',
            'dailyrecord.co.uk': 'Daily Record',
            'gallowaygazette.co.uk': 'Galloway Gazette',
            'carrickgazette.com': 'Carrick Gazette',
            'ardrossanherald.com': 'Ardrossan Herald',
            'irvinetime.co.uk': 'Irvine Times',
            'kilmarnockstandard.co.uk': 'Kilmarnock Standard',
            'ayshireadvertiser.co.uk': 'Ayrshire Advertiser',
            'dailyrecord.co.uk': 'Daily Record',
            ...
            'gazette-news.co.uk': 'Gazette',
            'yorkshirepost.co.uk': 'Yorkshire Post',
            'yorkshireeveningpost.co.uk': 'Yorkshire Evening Post',
            'examinerlive.co.uk': 'Huddersfield Examiner',
            'lep.co.uk': 'Lancashire Evening Post',
            'blackpoolgazette.co.uk': 'Blackpool Gazette',
            'lancashiretelegraph.co.uk': 'Lancashire Telegraph',
            'thetelegraphandargus.co.uk': 'Telegraph & Argus',
            'halifaxcourier.co.uk': 'Halifax Courier',
            'wakefieldexpress.co.uk': 'Wakefield Express',
            'doncasterfreepress.co.uk': 'Doncaster Free Press',
            'sheffieldstar.co.uk': 'Sheffield Star',
            'thestar.co.uk': 'The Star',
            'derbyshiretimes.co.uk': 'Derbyshire Times',
            'derbytelegraph.co.uk': 'Derby Telegraph',
            'nottinghampost.com': 'Nottingham Post',
            'lincolnshirelive.co.uk': 'Lincolnshire Live',
            'grimsbytelegraph.co.uk': 'Grimsby Telegraph',
            'hulldailymail.co.uk': 'Hull Daily Mail',
            'gazettelive.co.uk': 'Teesside Gazette',
            'sunderlandecho.com': 'Sunderland Echo',
            'hartlepoolmail.co.uk': 'Hartlepool Mail',
            'thenorthernecho.co.uk': 'The Northern Echo',
            'newsandstar.co.uk': 'News & Star',
            'nwemail.co.uk': 'North West Evening Mail',
            'westmorlandgazette.co.uk': 'Westmorland Gazette',

            // England - Midlands
            'birminghammail.co.uk': 'Birmingham Mail',
            'birminghamlive.co.uk': 'Birmingham Live',
            'coventrytelegraph.net': 'Coventry Telegraph',
            'leicestermercury.co.uk': 'Leicester Mercury',
            'stokesentinel.co.uk': 'Stoke Sentinel',
            'burtonmail.co.uk': 'Burton Mail',
            'lichfieldlive.co.uk': 'Lichfield Live',
            'expressandstar.com': 'Express & Star',
            'shropshirestar.com': 'Shropshire Star',
            'worcesternews.co.uk': 'Worcester News',
            'herefordtimes.com': 'Hereford Times',
            'northamptonchron.co.uk': 'Northampton Chronicle',
            'peterboroughtoday.co.uk': 'Peterborough Today',
            'cambridge-news.co.uk': 'Cambridge News',
            'cambridgeindependent.co.uk': 'Cambridge Independent',
            'eadt.co.uk': 'East Anglian Daily Times',
            'edp24.co.uk': 'Eastern Daily Press',
            'eveningnews24.co.uk': 'Norwich Evening News',
            'ipswichstar.co.uk': 'Ipswich Star',
            'suffolknews.co.uk': 'Suffolk News',

            // England - South
            'standard.co.uk': 'Evening Standard',
            'mylondon.news': 'MyLondon',
            'getwestlondon.co.uk': 'West London',
            'getsurrey.co.uk': 'Surrey Live',
            'kentlive.news': 'Kent Live',
            'kentonline.co.uk': 'Kent Online',
            'sussexlive.co.uk': 'Sussex Live',
            'theargus.co.uk': 'The Argus',
            'hampshirelive.news': 'Hampshire Live',
            'dailyecho.co.uk': 'Daily Echo',
            'bournemouthecho.co.uk': 'Bournemouth Echo',
            'dorsetecho.co.uk': 'Dorset Echo',
            'wiltshirelive.co.uk': 'Wiltshire Live',
            'swindonadvertiser.co.uk': 'Swindon Advertiser',
            'gloucestershirelive.co.uk': 'Gloucestershire Live',
            'oxfordmail.co.uk': 'Oxford Mail',
            'bucksfreepress.co.uk': 'Bucks Free Press',
            'buckinghamshirelive.com': 'Buckinghamshire Live',
            'bedfordshirelive.co.uk': 'Bedfordshire Live',
            'hertfordshiremercury.co.uk': 'Hertfordshire Mercury',
            'essexlive.news': 'Essex Live',
            'echo-news.co.uk': 'Echo',

            // England - South West
            'bristolpost.co.uk': 'Bristol Post',
            'bristollive.com': 'Bristol Live',
            'somersetlive.co.uk': 'Somerset Live',
            'weston-super-mare.co.uk': 'Weston Mercury',
            'devonlive.com': 'Devon Live',
            'plymouthherald.co.uk': 'Plymouth Herald',
            'exeterexpressandecho.co.uk': 'Exeter Express & Echo',
            'cornwalllive.com': 'Cornwall Live',
            'falmouthpacket.co.uk': 'Falmouth Packet',
            'westbriton.co.uk': 'West Briton',

            // Wales
            'walesonline.co.uk': 'Wales Online',
            'southwalesargus.co.uk': 'South Wales Argus',
            'southwalesevening.co.uk': 'South Wales Evening Post',
            'dailypost.co.uk': 'Daily Post',
            'northwaleschronicle.co.uk': 'North Wales Chronicle',
            'leaderlive.co.uk': 'The Leader',
            'cambrian-news.co.uk': 'Cambrian News',
            'countytimes.co.uk': 'County Times',
            'milfordmercury.co.uk': 'Milford Mercury',
            'taborynews.com': 'Tenby Observer',
            'carmarthenjournal.co.uk': 'Carmarthen Journal',
            'llanaborexpress.co.uk': 'Llanelli Star',
            'thebreconbeacon.co.uk': 'Brecon & Radnor Express',
            ...
            'londonderrysentinel.co.uk': 'Londonderry Sentinel',
            'armaghbanbridge.observer.co.uk': 'Armagh Banbridge Observer',
            'newrytoday.co.uk': 'Newry Today',
            'portadowntimes.co.uk': 'Portadown Times',
            'lurganmail.co.uk': 'Lurgan Mail',
            'ulstertstar.co.uk': 'Ulster Star',
            'ballymenatoday.co.uk': 'Ballymena Today',
            'antrimtoday.co.uk': 'Antrim Today',
            'carricktoday.co.uk': 'Carrickfergus Today',
            'larnetimes.co.uk': 'Larne Times',
            'newtownabbeytoday.co.uk': 'Newtownabbey Today',
            'colerainetimes.co.uk': 'Coleraine Times',
            'ballymenatimes.com': 'Ballymena Times',
            'midulstermail.co.uk': 'Mid Ulster Mail',
            'dungaborobserver.co.uk': 'Dungannon Observer',
            'fermanaghherald.com': 'Fermanagh Herald',
            'impartialreporter.com': 'Impartial Reporter',
            'strabanechronicle.com': 'Strabane Chronicle',
            'ulsterherald.com': 'Ulster Herald',
            'donegaldemocrat.ie': 'Donegal Democrat',
        };
